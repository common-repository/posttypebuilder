<?php
	...
	require_once('annotation_parser.php');
	...
	class AnnotationsBuilder {
		...
		public function instantiateAnnotation($class, $parameters, $targetReflection = false) {
			$class = Addendum::resolveClassName($class);
			if(is_subclass_of("Addendum\\" . $class, 'Addendum\Annotation') && !Addendum::ignores($class) || $class == 'Annotation') {
				$annotationReflection = new ReflectionClass("Addendum\\" . $class);
